...
<body>
    ...
    <table>
        ...
        <?php while ($fila = $resultado->fetch_assoc()) { ?>
            <tr>
                <td>
                    <!-- Verifica si la foto existe antes de mostrarla -->
                    <img src="http://localhost/SistemaVotaciones/uploads/<?php echo htmlspecialchars($fila['foto']); ?>" alt="Foto de <?php echo htmlspecialchars($fila['nombre']); ?>" width="100" height="100">
